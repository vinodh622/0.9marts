...
const Dashboard = ({navigation}) => {
    ...
    const unsubscribe = navigation.addListener('focus', () => {
      if (loginData === null) { 
       setIsLoadingList(false);
        ...
        fetch('http://ninecent.shiftlogics.com/api/voucher/viewVoucherAPP', {
          method: 'POST',
          headers: new Headers({
  ...
  //       fetch(
  //         'http://ninecent.shiftlogics.com/api/favourite/viewFavourite',
  //         {
  //           method: 'POST',
  //           headers: new Headers({
  //             Accept: 'application/json',
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener('focus', () => {
      if (loginData != null) {
        ...
        fetch(
          `http://ninecent.shiftlogics.com/api/user/data?api_token=${loginData.token}`,
          {
            method: 'GET',
            headers: new Headers({
              Accept: 'application/json',
    ...
    return (
      ...
      <View
        ...
        <View style={{width: '100%' ,
                ...
                aspectRatio: 800 / 450,}}>
          <Image
            source={{uri: `http://ninecent.shiftlogics.com/${item.photo}`}}
            style={[
        ...
        <View style={{flexDirection: 'row', padding: 15, alignItems: 'center',justifyContent:'space-between'}}>
          <View style={{flexDirection: 'column', paddingRight: 10}}>
            ...
            <Text numberOfLines={1} style={[StylesAll.md_Title12,]}>{item.link}</Text>
          </View>
          <View>
