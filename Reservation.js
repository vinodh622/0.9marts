...
const Reservation = ({navigation}) => {
  ...
  useEffect(() => {
    if (loginData != null) {
      ...
      fetch(
        'http://ninecent.shiftlogics.com/api/reservation/viewReservation',
        {
          method: 'POST',
          headers: new Headers({
  ...
  //}, []);
   ...
   const getOutlet = () =>{
    ...
    let abort = new AbortController();
    fetch(
      'http://ninecent.shiftlogics.com/api/outlet/viewOutlet',
      {
        method: 'POST',
        headers: new Headers({
          Accept: 'application/json',
  ...
  const removeReservationAPI = (itemValue) => {
    ...
    fetch(
      'http://ninecent.shiftlogics.com/api/reservation/cancelReservation',
      {
        method: 'POST',
        headers: new Headers({
          Accept: 'application/json',
                ...
                <TouchableOpacity
                  ...
                  <View
                    ...
                    <View style={{flex: 1}}>
                      <Image
                        source={{
                          uri: `http://ninecent.shiftlogics.com/${item.out_image}`,
                        }}
                        resizeMode="cover"
                        style={{
                          height: '100%',
                    ...
                    <View style={{backgroundColor: 'white'}}>
                      <View
                        ...
                        <View style={{height: 100, width: 100}}>
                          <Image
                            source={{
                              uri: `http://ninecent.shiftlogics.com/${currentSelectedOutLet.out_image}`,
                            }}
                            resizeMode="cover"
                                  ...
                                  <Formik
                                    ...
                                    onSubmit={async (Value) => {
                                      ...
                                      if (toggleCheckBox1 == true) {
                                        ...
                                        fetch(
                                          'http://ninecent.shiftlogics.com/api/reservation/addReservation',
                                          {
                                            method: 'POST',
                                            headers: new Headers({
                                              Accept: 'application/json',
