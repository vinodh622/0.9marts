...
const notificationValues = {
  ...
  useEffect(() => {
    ...
    GoogleSignin.configure({
      webClientId:'28147501709-vl0h6p7gnsscvkbumf404v04vq0e7tbb.apps.googleusercontent.com'
...
<Image
            ...
            <Formik
              ...
              onSubmit={async (values) => {
                ...
                fetch(
                  'http://ninecent.shiftlogics.com/api/user/loginphone',
                  {
                    method: 'POST',
                    headers: new Headers({
