...
const RewardDetails = ({navigation, route}) => {
  ...
  useEffect(() => {
    ...
    fetch('http://ninecent.shiftlogics.com/api/redeem/checkRedeem', {
      method: 'POST',
      headers: new Headers({
  ...
  const setreddem = () => {
    ...
    fetch('http://ninecent.shiftlogics.com/api/redeem/addRedeem', {
      method: 'POST',
      headers: new Headers({
        Accept: 'application/json',
        'Content-Type': 'multipart/form-data',
    ...
    <View style={[StylesAll.flexWtrapper, {backgroundColor: '#fafbfb'}]}>
      ...
      <SafeAreaView style={{flex: 1, flexDirection: 'column'}}>
        ...
        <View
          ...
          <ImageBackground
            source={{
              uri: `http://ninecent.shiftlogics.com/${route.params?.dataValue.photo}`,
            }}
            style={[
